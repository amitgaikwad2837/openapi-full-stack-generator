# v0.1 Engineering Backlog - OpenAPI to Full Stack Generator

## 1. Release Objective

- Product Type: CLI
- Primary Command/API: generate-stack
- v0.1 Goal: Generate backend contracts plus SDK/hooks/mock server/test skeletons from OpenAPI.
...
openapi spec, generation config

### Outputs

generated prisma/nestjs/sdk/hooks/mock/tests folders with manifest
...
- Core Acceptance Test: Given OpenAPI sample, generator produces compilable TypeScript outputs and snapshot-stable manifest.
